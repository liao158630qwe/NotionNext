...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'majima', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lzdife.top', // 网站地址
...
,
    {
      name: '孤独患者',
      artist: '陈奕迅',
      url: 'https://music.163.com/song/media/outer/url?id=64093.mp3',
      cover:
        'https://p2.music.126.net/Po0tJTtv4aBaYozWlnojHg==/18546562139313276.jpg'
    }
